...
<body style="background-color: #EDE7D3;">
    <div class="container" style="float:cente; padding:15%; border: 3px solid black; margin-top:5%">
        <div>
            <h1>No se encuentra conectado a una sesión.</h1>
        </div>
        <a href="<?php echo base_url() ?>/signin" tabindex="-1" aria-disabled="true"> <button type="button" name="login" id="login" class="btn btn-primary btn-lg">Iniciar sesión</button></a>

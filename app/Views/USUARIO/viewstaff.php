...
<body>
  <div class="container" style="margin-top:1%;background: rgba(0, 133, 255, 0.65);  border-style: ridge;border-color:azure; border-width:8px;margin-top:2.5%;">
      ...
      <tbody class='table-group-divider' style="background-color:#FFFFFF;">
        <?php foreach ($listaPersonal as $item) : ?>
          <tr>
            ...
            <?php if ($S_Per_tipo == 2) : ?>
              <td><a href="<?php echo base_url() . '/VerStaff/editar/question/' . $item['Per_cod'] ?>">Modificar</a></td>
            <?php endif ?>
            <?php if ($S_Per_cod == 100) : ?>
              <td><a href="<?php echo base_url() . '/VerStaff/eliminar/question/' . $item['Per_cod'] ?>">Borrar</a></td>
            <?php endif ?>
          </tr>
